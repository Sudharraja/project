...
<div class="container">
  ...
  <td>
   <input type="text" name="user_code" id="name" class="form-control" value="<?php if($action=="edit"){ echo $data['user_code'];}else {echo "";} ?>" placeholder="Name" required="required" autofocus="autofocus">
  </td>
  </tr>
  <tr>
        ...
        $("body").on("click", "#btnExport", function () {
            html2canvas($('#example1')[0], {
                onrendered: function (canvas) {
                    ...
                    pdfMake.createPdf(docDefinition).download("experience_details.pdf");
                }
            });
        });
    </script>
